...
public class Sleeve extends OpenCvPipeline {
    /*
    YELLOW  = Parking Left
    CYAN    = Parking Middle
    ...
    private static Point SLEEVE_TOPLEFT_ANCHOR_POINT = new Point(120, 20);
    ...
    private static final Scalar
            ...
            lower_magenta_bounds = new Scalar(190, 0, 120, 200),
